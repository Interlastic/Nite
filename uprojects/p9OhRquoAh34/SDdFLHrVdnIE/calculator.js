...
document.addEventListener('DOMContentLoaded',() => {updateDisplay(); setupButtons();});
    ...
    document.querySelectorAll('.calc-btn').forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            switch(action) {
                ...
                case 'inputPercent': inputPercent(); break;
                case 'setOperator': setOperator(value); break;
                case 'inputNumber': inputNumber(value); break;
                case 'inputDecimal': inputDecimal(); break;
